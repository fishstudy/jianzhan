...
abstract class Ajaxpage implements ArrayAccess, Countable, IteratorAggregate, JsonSerializable
{
    /** @var bool 是否为简洁模式 */
    ...
    public function __construct($ajax_func,$items, $listRows, $currentPage = null, $total = null, $simple = false, $options = [])
    {
