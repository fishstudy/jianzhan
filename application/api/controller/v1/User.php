...
class User extends Base{
     ...
     * "nickname"=>"昵称",
     * 请求方式 post
     * 请求URL：http://huiminschool.dev.com:8088/v1/api/user/add
     *
     */
	public function add(){
        try {
            ...
            $res = $this->validate($addAry, "Useradvance");
            if ($res !== true) {
     ...
     *  从新登陆token 会发生改变
     * 请求方式 post
     * 请求URL：http://huiminschool.dev.com:8088/v1/api/user/login
     *
     */
     ...
     * 请求方式 GET
     * 参数 uid 用户ID
     * 路径：http://huiminschool.dev.com:8088/v1/api/user/detail?uid=3
     ...
     * 参数 token 用户token
     * 请求方式 GET
     * http://huiminschool.dev.com:8088/v1/api/user/getInfoByToken?token=32wweewewwe
     */
