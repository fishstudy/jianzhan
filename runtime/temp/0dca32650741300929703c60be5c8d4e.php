<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"D:\phpstudy_pro\WWW\huimin/application/admin\view\ad\index.html";i:1506940971;s:68:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\header.html";i:1506935140;s:68:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\dialog.html";i:1504823103;s:67:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\color.html";i:1506937069;s:68:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\footer.html";i:1505402999;}*/ ?>
 <!-- 头部 -->
...
<!-- 头部 --> 
					  ...
					  <div class="group">
					   ...
					   <div class="group">
					     链接：<input type="text" name="url"  class="search_ipt" value="<?php echo input('url'); ?>"/>
						  ...
						  <div class="group">
					     排序：<input type="text" name="sort"  class="search_ipt end" value="<?php echo input('sort'); ?>"/><input type="button" class="search_btn"value="搜索" onclick="$('.search-form').submit()">
					  </div>
		...
		<th class="">操作</th>
				       ...
				       <?php if(is_array($res['list']) || $res['list'] instanceof \think\Collection || $res['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $res['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
									...
									<td><?php echo $vo['id']; ?> </td>	<td><a href="<?php echo U('auth/edit?id='.$vo['id']); ?>"><?php echo $vo['title']; ?></a> </td>
