<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:68:"D:\phpstudy_pro\WWW\huimin/application/admin\view\channel\index.html";i:1506941039;s:68:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\header.html";i:1506935140;s:68:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\dialog.html";i:1504823103;s:67:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\color.html";i:1506937069;s:68:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\footer.html";i:1505402999;}*/ ?>
 <!-- 头部 -->
		...
		<th class="">操作</th>
			   ...
			   <td class="list_opr">
									 ...
									 <a data-url="<?php echo url('del?id='.$vo['id']); ?>" class="del_btn cur">删除</a>
                                            ...
                                            <tr class="even gradeC">
                                           <td> 
											<input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo $vo1['id']; ?>">
                                                </td>
										 <td style="text-align:left">|___<?php echo (isset($vo1['title']) && ($vo1['title'] !== '')?$vo1['title']:""); ?></td>
						
					 <td><?php echo (isset($vo1['url']) && ($vo1['url'] !== '')?$vo1['url']:""); ?></td>
						 <td><?php echo (isset($vo1['sort']) && ($vo1['sort'] !== '')?$vo1['sort']:""); ?></td>
						<td><?php echo (isset($vo1['status']) && ($vo1['status'] !== '')?$vo1['status']:""); ?></td>
