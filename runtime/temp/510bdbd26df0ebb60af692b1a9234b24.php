<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:67:"D:\phpstudy_pro\WWW\huimin/application/admin\view\picture\edit.html";i:1499589489;s:68:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\header.html";i:1610938211;s:68:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\dialog.html";i:1504823103;s:67:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\color.html";i:1506937069;s:68:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\footer.html";i:1610936969;}*/ ?>
 <!-- 头部 -->
			...
			<div class="tips_msg none"><span class="tips">保存成功</span><span class="close_tips"></span></div>
				...
				<div class="edit_box">
					...
					<div class="edit_content">
						    ...
						    <div class="input_title">路径<span>(path)</span></div>
							<input type="text" name="path" class="input_box" value="<?php echo (isset($info['path']) && ($info['path'] !== '')?$info['path']:""); ?>"/>
							<div class="input_title">md5<span>(md5)</span></div>
						  <input type="text" id="user-weibo" class="input_box" name="md5" value="<?php echo (isset($info['md5']) && ($info['md5'] !== '')?$info['md5']:""); ?>">
							  <div class="input_title">sha1<span>(sha1)</span></div>
							<input type="text" name="sha1" class="input_box" value="<?php echo (isset($info['sha1']) && ($info['sha1'] !== '')?$info['sha1']:""); ?>"/>
				      	
						</div>
						<div class="edit_content_tab none">
							<div class="input_title">状态<span>(0-禁用，1-正常)</span></div>
                             <input type="text" name="status" class="input_box" value="<?php echo (isset($info['status']) && ($info['status'] !== '')?$info['status']:""); ?>"/>
