<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:71:"D:\phpstudy_pro\WWW\huimin/application/admin\view\attributes\index.html";i:1506941007;s:68:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\header.html";i:1506935140;s:68:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\dialog.html";i:1504823103;s:67:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\color.html";i:1506937069;s:68:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\footer.html";i:1505402999;}*/ ?>
 <!-- 头部 -->
		 ...
		 <?php if(is_array($res['list']) || $res['list'] instanceof \think\Collection || $res['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $res['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
								         ...
								         <td><?php echo (isset($vo['title']) && ($vo['title'] !== '')?$vo['title']:""); ?> </td>
											   <td><?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:""); ?> </td>
                                                <td><?php echo get_models($vo['model_id'],"title"); ?></td>
                                              <td><?php echo (isset($vo['type']) && ($vo['type'] !== '')?$vo['type']:""); ?></td>
