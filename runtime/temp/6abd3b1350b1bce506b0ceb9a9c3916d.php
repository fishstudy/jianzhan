<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:65:"D:\phpstudy_pro\WWW\huimin/application/admin\view\user\index.html";i:1610714570;s:68:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\header.html";i:1506935140;s:68:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\dialog.html";i:1504823103;s:67:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\color.html";i:1506937069;s:68:"D:\phpstudy_pro\WWW\huimin/application/admin\view\public\footer.html";i:1505402999;}*/ ?>
 <!-- 头部 -->
			...
			<div class="content">
				...
				<div class="search">
					<form class="search-form"  action="<?php echo url(); ?>" method="post">
					  <div class="group">
					       名称：<input type="text" name="username" class="search_ipt" value="<?php echo input('username'); ?>"/>
					  
					  </div>
						  <div class="group">
					     报名号：<input type="text" name="numbers"  class="search_ipt" value="<?php echo input('numbers'); ?>"/>
					  </div>
					   <div class="group">
					     手机号：<input type="text" name="mobile"  class="search_ipt" value="<?php echo input('mobile'); ?>"/>
						  </div>
						  <div class="group"> 类型：
							<input type="text" name="type"  class="search_ipt end" value="<?php echo input('type'); ?>"/>
				 ...
				 <tr>	
				     ...
				     <?php if(is_array($res['list']) || $res['list'] instanceof \think\Collection || $res['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $res['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
											...
											<input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo $vo['id']; ?>">
												...
												<td> <?php echo (isset($vo['idcard']) && ($vo['idcard'] !== '')?$vo['idcard']:""); ?></td>
												<td><?php echo (isset($vo['mobile']) && ($vo['mobile'] !== '')?$vo['mobile']:""); ?></td>
											    <td><?php echo (isset($vo['sex']) && ($vo['sex'] !== '')?$vo['sex']:""); ?> </td>
											    <td><?php echo (isset($vo['education']) && ($vo['education'] !== '')?$vo['education']:""); ?> </td>
											    <td> <?php echo (isset($vo['professional']) && ($vo['professional'] !== '')?$vo['professional']:""); ?></td>
												...
												<td> <?php echo (isset($vo['detail']) && ($vo['detail'] !== '')?$vo['detail']:""); ?></td>
											<td class="list_opr"><span class="opr_box">
