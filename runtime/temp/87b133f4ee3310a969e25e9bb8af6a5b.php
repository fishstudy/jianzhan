...
<div class="main">
     <div class="w1200">
          <div class="section">
               <div class="home">你的当前位置：	<a href="#">首页</a> ><?php foreach($pid as $vo): ?>  
			<a href="<?php echo url('article/lists?id='.$vo); ?>"><?php echo get_category_title($vo); ?></a><span>&gt;</span>
		<?php endforeach; ?><a href="<?php echo url('article/lists?id='.$info['category_id']); ?>"><?php echo get_category($info['category_id'],"title"); ?></a><span>&gt;</span> <em><?php echo $meta_title; ?></em></div>
               <div class="contain">
                    <div class="fl leftside">
                    <div class="nav">
                     <h1 class="tit"><?php echo get_category($info['category_id'],"title"); ?></h1>
                     <div class="nav_list">
                     <ul>
					 <?php foreach($pid as $vo): ?>  
			   <li><a href="<?php echo url('article/lists?id='.$vo); ?>"><?php echo get_category_title($vo); ?></a></li>
		<?php endforeach; ?>
		<li><a href="<?php echo url('article/lists?id='.$info['category_id']); ?>"><?php echo get_category_title($info['category_id']); ?></a></li>
	...
	<p class="write">来源：<span><?php echo get_username($info['uid']); ?></span>　　浏览量：<span><script language="javascript" src="/index.php/View/hits/id/142.html"></script><?php echo $info['view']; ?></span>　　发布时间：<span>2017-06-23 11:10:35</span></p>
	<div style="font-size:14px; line-height:25px;">
	  <?php echo $info['content']; ?>
	   </div>
	
	<div class="dow" style="line-height:25px;">
	<div><b>上一篇：</b><a href="<?php echo url('article/detail?id='.$pre['id']); ?>"><?php echo (isset($pre['title']) && ($pre['title'] !== '')?$pre['title']:"没有了"); ?></a></div>
	<div><b>下一篇：</b><a href="<?php echo url('article/detail?id='.$next['id']); ?>"><?php echo (isset($next['title']) && ($next['title'] !== '')?$next['title']:"没有了"); ?></a></div>
	</div>
...
<div class="footer">
     ...
     <p>联系我们版权所有©湖北大学知行学院 <?php echo C("ISP"); ?> 本站介绍：湖北大学知行学院新闻中心</p>
