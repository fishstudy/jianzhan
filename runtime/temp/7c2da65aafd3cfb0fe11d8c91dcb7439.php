<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:84:"/home/release/webserver/php/project/huimin/application/admin/view/document/edit.html";i:1611123242;s:84:"/home/release/webserver/php/project/huimin/application/admin/view/public/header.html";i:1611123245;s:84:"/home/release/webserver/php/project/huimin/application/admin/view/public/dialog.html";i:1611123244;s:83:"/home/release/webserver/php/project/huimin/application/admin/view/public/color.html";i:1611123244;s:84:"/home/release/webserver/php/project/huimin/application/admin/view/public/footer.html";i:1611123245;}*/ ?>
 <!-- 头部 -->
...
<!-- 头部 -->
	  ...
	  <script type="text/javascript" src="__COMMON__/laydate/laydate.js"></script>
			...
			<div class="tips_msg none"><span class="tips">保存成功</span><span class="close_tips"></span></div>
				...
				<div class="edit_box">
					<div class="edit_title">当前位置:<?php foreach($ids as $vo): ?>  
		...
		<?php endforeach; ?><?php echo (isset($meta_title) && ($meta_title !== '')?$meta_title:""); ?></div>
					...
					<div class="edit_content">
                       ...
                       <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$v): ?>
							...
							<input type="text" name="<?php echo $vo['name']; ?>" class="input_box" value="<?php echo (isset($info[$vo['name']]) && ($info[$vo['name']] !== '')?$info[$vo['name']]:''); ?>"/>
								<?php break; case "string": ?>
                                 <div class="input_title"><?php echo $vo['title']; ?><span>(<?php echo (isset($vo['remark']) && ($vo['remark'] !== '')?$vo['remark']:""); ?>)</span></div>
							<input type="text" name="<?php echo $vo['name']; ?>" class="input_box" value="<?php echo (isset($info[$vo['name']]) && ($info[$vo['name']] !== '')?$info[$vo['name']]:''); ?>"/>
								<?php break; case "textarea": ?>
                                 <div class="input_title"><?php echo $vo['title']; ?><span>(<?php echo (isset($vo['remark']) && ($vo['remark'] !== '')?$vo['remark']:""); ?>)</span></div>
						     	<textarea name="<?php echo $vo['name']; ?>"/><?php echo (isset($info[$vo['name']]) && ($info[$vo['name']] !== '')?$info[$vo['name']]:''); ?></textarea>
								<?php break; case "editor": ?>
                                <div class="input_title"><?php echo $vo['title']; ?><span>(<?php echo (isset($vo['remark']) && ($vo['remark'] !== '')?$vo['remark']:""); ?>)</span></div>
						  <textarea class="am-validate" id="content" name="<?php echo $vo['name']; ?>" required><?php echo (isset($info[$vo['name']]) && ($info[$vo['name']] !== '')?$info[$vo['name']]:''); ?></textarea>		
	     ...
	     function setVal(){ //取值
		    var option = $(".<?php echo $vo['name']; ?> img");
           ...
           $("input[name='<?php echo $vo['name']; ?>']").val(ids);
						   ...
						   <script type="text/javascript">
                             ...
                             <div class="input_title"><?php echo $vo['title']; ?><span>(<?php echo $vo['remark']; ?>)</span></div>
                                    <?php $_result=parse_attr($vo['extra']);if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>
                                        <input type="radio" value="<?php echo $key; ?>" <?php if($info[$vo['name']] == $key): ?>checked<?php endif; ?>><?php echo $vo1; ?></option>
	 ...
	 <script type="text/javascript">
    $("select[name='url']").val("<?php echo (isset($info['url']) && ($info['url'] !== '')?$info['url']:'0'); ?>");
    </script>
