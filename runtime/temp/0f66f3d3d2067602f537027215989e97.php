<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:84:"/home/release/webserver/php/project/huimin/application/admin/view/ucenter/index.html";i:1611123245;s:84:"/home/release/webserver/php/project/huimin/application/admin/view/public/header.html";i:1611123245;s:84:"/home/release/webserver/php/project/huimin/application/admin/view/public/dialog.html";i:1611123244;s:83:"/home/release/webserver/php/project/huimin/application/admin/view/public/color.html";i:1611123244;s:84:"/home/release/webserver/php/project/huimin/application/admin/view/public/footer.html";i:1611123245;}*/ ?>
 <!-- 头部 -->
				...
				<div class="search">
					<form class="search-form"  action="<?php echo url(); ?>" method="post">
					  <div class="group">
						  ...
						  <div class="group">
					     邮箱：<input type="text" name="name"  class="search_ipt" value="<?php echo input('name'); ?>"/>
					  </div>
					   <div class="group">
					     手机号：<input type="text" name="mobile"  class="search_ipt" value="<?php echo input('mobile'); ?>"/>
						  </div>
						  <div class="group"> 类型：
							<input type="text" name="name"  class="search_ipt end" value="<?php echo input('name'); ?>"/>
 ...
 <th>授权</th>												 
				     ...
				     <?php if(is_array($res['list']) || $res['list'] instanceof \think\Collection || $res['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $res['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
											...
											<input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo $vo['id']; ?>">
											   ...
											   <td><?php echo (isset($vo['password']) && ($vo['password'] !== '')?$vo['password']:""); ?></td>
											  <td><?php echo (isset($vo['email']) && ($vo['email'] !== '')?$vo['email']:"无"); ?> </td>
