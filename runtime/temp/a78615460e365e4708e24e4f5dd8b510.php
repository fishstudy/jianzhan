<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:85:"/home/release/webserver/php/project/huimin/application/admin/view/document/index.html";i:1611123242;s:84:"/home/release/webserver/php/project/huimin/application/admin/view/public/header.html";i:1611123245;s:84:"/home/release/webserver/php/project/huimin/application/admin/view/public/dialog.html";i:1611123244;s:83:"/home/release/webserver/php/project/huimin/application/admin/view/public/color.html";i:1611123244;s:84:"/home/release/webserver/php/project/huimin/application/admin/view/public/footer.html";i:1611123245;}*/ ?>
 <!-- 头部 -->
...
<!-- 头部 --> 
			<div class="content">
				...
				<div class="search">
					<form class="search-form"  action="<?php echo url(); ?>" method="get">
					  <div class="group">
					...
					<table class="list_table">
					              <tr>  <th> <input class="checkbox check-all" type="checkbox">
				                    ...
				                    <?php if(is_array($res['list']) || $res['list'] instanceof \think\Collection || $res['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $res['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        ...
                                        <a href="<?php echo site_url(); ?>/index.php/index/article/detail/id/<?php echo $vo['id']; ?>" target="_blank">预览</a>
										</span>          
										</td>
										</tr>
